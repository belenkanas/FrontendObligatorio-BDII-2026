    ...
    <DrawerContentScrollView {...props}>
      ...
      {rol === 'ADMINISTRADOR' && (
        <>
          ...
          <DrawerItem label="Gestión de eventos y sectores" onPress={() => router.push('/admin-gestion-eventos')} />
        </>
      )}
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <AuthProvider>
        <Drawer drawerContent={(props) => <CustomDrawer {...props} />}>
          ...
          <Drawer.Screen name="admin-gestion-eventos" options={{ title: 'Gestión de eventos y sectores' }} />
